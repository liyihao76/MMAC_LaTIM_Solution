...
class Model_ensemble(nn.Module):
    def __init__(self,load_weights,path1,path2,path3):
        ...
        self.model3 = timm.create_model('tf_efficientnetv2_l', pretrained=False, num_classes=1, in_chans=3)
        if load_weights == True:
...
class model:
    def __init__(self):
        ...
        self.checkpoint2 = "v3_f2.pth"
        self.checkpoint3 = "v3_f4.pth"
    ...
    def load(self, dir_path):
        ...
        checkpoint_path3 = os.path.join(dir_path, self.checkpoint3)
        self.model = Model_ensemble(True,checkpoint_path,checkpoint_path2,checkpoint_path3)
