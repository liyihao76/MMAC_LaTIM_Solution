...
### 设置参数
images_file = '/data_GPU/yihao/MMAC/Task2/2. Segmentation of Myopic Maculopathy Plus Lesions/3. Fuchs Spot/1. Images/1. Training Set'  # 训练图像路径
gt_file = '/data_GPU/yihao/MMAC/Task2/2. Segmentation of Myopic Maculopathy Plus Lesions/3. Fuchs Spot/2. Groundtruths/1. Training Set'
